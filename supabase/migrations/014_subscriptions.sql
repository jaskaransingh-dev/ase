...
CREATE TABLE IF NOT EXISTS subscriptions (
  ...
  ends_at       timestamptz,                      -- null = never expires (beta)
...
ALTER TABLE agents ADD COLUMN IF NOT EXISTS backtest_stats      jsonb;        -- cached backtest results
ALTER TABLE agents ADD COLUMN IF NOT EXISTS primary_symbol      text;         -- e.g. BTC-USD
ALTER TABLE agents ADD COLUMN IF NOT EXISTS backtest_strategy   text;         -- e.g. momentum_crossover
