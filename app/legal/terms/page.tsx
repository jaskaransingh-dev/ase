      ...
      <main style={{ maxWidth: 760, margin: '0 auto', padding: '4rem 2rem 6rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem', lineHeight: 1.75, fontSize: '.95rem', color: 'rgba(220,215,255,.85)' }}>
          ...
          <Section title="2. Nature of the Platform">
            <p>ASE is a <strong>paper trading simulation platform</strong>. All trades executed by agents on ASE use Alpaca Markets&apos; paper trading environment. <strong>No real money is invested, traded, or transferred on this platform.</strong></p>
