...
export const STRATEGY_TEMPLATES: Record<string, Omit<QuantStrategyPackage, 'id' | 'name'>> = {
  'momentum_conservative': {
    ...
    optimizerConfig: { ...DEFAULT_OPTIMIZER, riskAversion: 8, maxWeight: 0.30, turnoverPenalty: 0.5, maxTurnover: 0.20 },
    executionConfig: { ...DEFAULT_EXECUTION, slippageBps: 8 },
    riskLimits:      { ...DEFAULT_RISK_LIMITS, maxDrawdownTrigger: 0.20, maxGrossExposure: 0.90 },
    alphaType:       'momentum',
    forecastHorizon: 20,
    signalScaleBps:  80,
  ...
  'mean_reversion_active': {
    ...
    optimizerConfig: { ...DEFAULT_OPTIMIZER, riskAversion: 4, maxWeight: 0.20, turnoverPenalty: 0.2, maxTurnover: 0.40 },
    executionConfig: { ...DEFAULT_EXECUTION, slippageBps: 6 },
    riskLimits:      { ...DEFAULT_RISK_LIMITS, maxDrawdownTrigger: 0.25 },
  ...
  'ml_aggressive': {
    ...
    optimizerConfig: { ...DEFAULT_OPTIMIZER, riskAversion: 4, maxWeight: 0.30, turnoverPenalty: 0.1 },
    executionConfig: { ...DEFAULT_EXECUTION, participationRate: 0.15 },
    riskLimits:      { ...DEFAULT_RISK_LIMITS, maxDrawdownTrigger: 0.30 },
    alphaType:       'ml',
    forecastHorizon: 10,
    signalScaleBps:  100,
    rebalanceFreq:   'daily',
