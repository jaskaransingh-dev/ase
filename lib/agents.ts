...
// Note: equity agents (SPY, QQQ, XLK, etc.) removed — Kraken only supports
// crypto. Equity slugs still exist in the DB but status='inactive' so they
// don't appear in the marketplace or run in the cron.
